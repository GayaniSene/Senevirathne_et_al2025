#This is the code for CellChat_E57 spatial sections

data_dir <- 'outs_57_02_new' #ventral section
...
spatial <- RenameIdents(spatial, '0' = 'Tendons','1' = 'Chondro1','2' = 'Muscles1')
spatial <- RenameIdents(spatial, '3' = 'Perichondrium', '4' ='Mes1', '5' = 'Chondro2')
spatial <- RenameIdents(spatial, '6' = 'Chondro3', '7' = 'Chondro4', '8'='Muscles2','9'='Mes2')

spatial$celltype <- Idents(spatial)

save(spatial, file = "visium_57_02.RData")

load("visium_57_02.RData")
...
cluster_colors <- c("Tendons" = "#f652a0", "Chondro1" = "#7ec8e3", "Muscles1" = "#ef7c8e", "Perichondrium"="#145da0",
                    "Mes1" = "#a47551", "Chondro2" = "blue","Chondro3" = "darkblue", "Chondro4"="#0c2d48", "Muscles2"="#fa26a0","Mes2"="#a45c40")
...
netVisual_aggregate(cellchat, 
                    ...
                    point.size = 3)     # Specify which metadata column to color by
