...
Scenic+ input files 
#Refere to SCENIC+_E53_IL for the code to use scanpy for pre-RNA processing.  

#here is the code to extract from Seurat.

#First step is to run Seurat to identify cell types and get the cell annotations as a cell_data.csv file.
...
cd /n/boslfs02/LABS/capellini_lab/users/msenevirathne/Multiomics/E67_E72_2024_April_Hg38/RNA-seq/count/E72_IL/outs

cd /n/boslfs02/LABS/capellini_lab/users/msenevirathne/Multiomics/E67_E72_2024_April_Hg38/RNA-seq/count/E72_AC/outs
...
fragments_dict = {"SeuratProject": "atac_fragments.tsv.gz"}


#First we read the barcode-to-cell type annotation as a pd.DataFrame
import pandas as pd
cell_data = pd.read_table("cell_data.tsv", index_col = 0)
cell_data.head()
...
------------------------------------------------------------------
#After the SHELL commands, run these in a python environment ( a .py command line new script is needed for this part)
#!/usr/bin/env python

from pycisTopic.plotting.qc_plot import plot_sample_stats, plot_barcode_stats
import matplotlib.pyplot as plt
fragments_dict = {
    "SeuratProject": "atac_fragments.tsv.gz"
}
...
#changed the workind directory to the locaton where the cistopic object is saved:



wget https://github.com/mimno/Mallet/releases/download/v202108/Mallet-202108-bin.tar.gz
!tar -xf Mallet-202108-bin.tar.gz
(#If this command doesn't work copy paste the Mallet software folder from 53/57)


mkdir -p /mallet/tutorial/
#if this doesn't work, make a folder called "mallet/tutoiral"


#run these on python environment on the cluster
...
################# can open a .py file or can also run it on the computer
#!/usr/bin/env python
import pickle
import os
out_dir = "outs"
